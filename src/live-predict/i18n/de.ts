...
export const de = {
  ...
  brand: {
    appName: 'Adidas Club Punkte Arena',
    tagline: 'Setze deine Club Punkte auf Live-Fußball',
  ...
  games: {
    ...
    submit: 'Vorhersage abgeben',
    submitted: 'Vorhersage gespeichert',
    windowOpen: 'Live-Vorhersage',
  },
